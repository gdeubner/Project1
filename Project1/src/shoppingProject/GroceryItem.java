...
/**
 * This class defines the GroceryItem abstract data type with 3 data fields and contains methods 
 * to return a string containing the item name, its price, and whether or not it is taxable.
 * It contains a parameterized constructor which defines three data fields for a GroceryItem object.
 * 
...
public class GroceryItem {
	...
	/**
	 * Parameterized constructor that defines abstract data type GroceryItem
	 * as having three elements: name, price, taxable.
	 * @param name of item
	 * @param price of item
	...
	/**
	 * This method is used to return the proper label for an item being taxable or tax free.
	...
	/**
	 * This method returns a String that represents the three data fields of a GroceryItem object.
	 * The three elements are the item's name, its price (formatted using the format() method 
	 * in the DecimalFormat package), and whether or not the item is taxable, which is 
	 * done by calling the isTaxable(taxable) method.
	 */
